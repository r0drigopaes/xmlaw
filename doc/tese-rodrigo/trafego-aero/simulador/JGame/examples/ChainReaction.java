...
public class ChainReaction extends JGEngine {
	...
	public ChainReaction() { initEngineApplet(20,15,32,32,null,null,null); }
	public ChainReaction(int x,int y) {
		initEngine(20,15,32,32,null,null,null,x,y);
	}
	public void initGame() {
		defineMedia("examples/chain_reaction.tbl");
		setFrameRate(40,4);
		setGameState("Title");
	...
	Font scoring_font = new Font("Helvetica",0,12);
	public class Scoring extends JGObject {
		String msg;
		Color [] cols;
		public Scoring(String message,double x,double y,Color [] colors) {
		...
		public void hit(JGObject obj) {
			...
			if (count.value > 4 && count.value < 10) {
				...
				new StdScoring("Scoring",x+16,y,0,-1,80,
					...
					new Color [] {Color.yellow,new Color(128,64,0)},2);
			}
			new Explo(x+16,y+16, count);
			new StdScoring("Scoring",x+16,y+16,0,-1,80, count.value+"0 pts",
				scoring_font,new Color[] {Color.blue,Color.blue,Color.cyan},2);
			remove();
		}
	}
