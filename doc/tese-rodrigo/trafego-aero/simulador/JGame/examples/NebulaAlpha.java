...
public class NebulaAlpha extends JGEngine {
	...
	public NebulaAlpha() { initEngineApplet(20,15,32,32,null,null,null); }
	public NebulaAlpha(int x,int y){initEngine(20,15,32,32,null,null,null,x,y);}
	public void initGame() {
		defineMedia("examples/nebula_alpha.tbl");
		setBGImage("bgimg");
		setFrameRate(40,4);
		setGameState("Title");
