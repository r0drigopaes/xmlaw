...
public class Launcher {
	public static String [] [] gameinfo = {
		...
		{"Matrix Miner", "examples.MatrixMiner",
		...
		{"Nebula Alpha", "examples.NebulaAlpha",
		...
		{"Space Run II", "examples.SpaceRunII",
			...
			"html/spacerun-grab-thumb.gif"},
		{"Water World", "examples.WaterWorld",
	...
	public static void main(String [] args) {
		...
		list.setFont(new Font("Helvetica",Font.BOLD,22));
		...
		desc_area = new JTextArea(
			...
			+"Version: 1.3, 30 march 2007.\n\n"
			+"Select your game!\n\n"
			+"Visit the website at\nwww.13thmonkey.org/~boris/jgame/\n\n");
		desc_area.setEditable(false);
		desc_area.setFont(new Font("Arial",Font.BOLD,16));
		...
		startbut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Object args2 = Array.newInstance(String.class,2);
