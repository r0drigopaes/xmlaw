...
// object cids: 1=player 2=monster 4=bullet 8=monsterbullet
	...
	public static void main(String [] args) {
		new DungeonsOfHack(parseSizeArgs(args));
	}
	public DungeonsOfHack() { initEngineApplet(60,40,10,10,null,null,null); }
	public DungeonsOfHack(Dimension size) {
		initEngine(60,40,10,10,null,null,null,size.width,size.height);
	}
	public void initGame() {
		defineMedia("examples/dungeons_of_hack.tbl");
		setFrameRate(30,4);
