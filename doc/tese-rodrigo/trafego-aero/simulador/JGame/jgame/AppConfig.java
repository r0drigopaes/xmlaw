 ...
 */
	...
	/** The object in which the fields are to be configured, null means none
	 * (file only). */
	Object obj=null;
	...
	*/
	 ...
	 * found in the object, if the object is defined, or null otherwise.
	 */
	...
	* any class or String for String representations of fields. */
	...
	class KeyField extends JTextField implements KeyListener,FocusListener {
		...
		public void setValue(int keyval) {
			setText(JGEngine.getKeyDesc(keyval));
		}
		public int getValue() {
			return JGEngine.getKeyCode(getText());
		}
		public void processKeyEvent(KeyEvent e) {
			int keycode = e.getKeyCode();
			if (keycode!=0) {
				setText(JGEngine.getKeyDesc(keycode));
				processAction(fieldname,new Integer(keycode));
			}
		}
		public void keyPressed(KeyEvent e) {
			//setText(JGEngine.getKeyDesc(e.getKeyCode()));
			//processAction(fieldname,new Integer(e.getKeyCode()));
		}
