...
public class ActivatedNormRefHandler extends AbstractHandler {
	protected Hashtable pendingList = new Hashtable();

	public ActivatedNormRefHandler(Stack<Object> stack, DescriptorTable table, Hashtable<Id, Object> handlerCache) {
